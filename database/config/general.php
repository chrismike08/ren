...
define( 'LANGUAGE_SEPARATOR', $config['language_separator'] );
    define( 'TinyMceFullActive', true );
    define( 'CKEditorActive', true );
...
/*
* If you want to detect mobile devices and redirect to mobile version
*/
...
$aMenuTypes = Array( 1 => $lang['Menu_1'], 2 => $lang['Menu_2'], 4 => 'Random page', 3 => $lang['News'] );
...
$config['last_login'] = "1672799511";
$config['before_last_login'] = "1672629207";
