...
class Pages
{
  ...
  * @param int $iPage
  */
  public function listSimpleNews( $iType ){
    global $lang;
    ...
    for( $i = 0; $i < $iCount; $i++ ){
      ...
      $content .= '<li class="l'.( ( $i % 2 ) ? 0: 1 ).'"><h3><a href="'.$aData['sLinkName'].'">'.$aData['sName'].'</a></h3>'.$sDescription.'</li>';
    } // end for

    if( isset( $content ) )
      return '<div id="simpleNews"><div class="type">'.$lang['News'].'</div><ul class="content">'.$content.'</ul></div>';
  } // end function listSimpleNews
