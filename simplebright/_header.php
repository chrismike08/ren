...
<div id="container">
  <div id="header">
    ...
    <div id="head3"><?php // top menu starts here ?>
      <div class="container">
        <img src="<?php echo $config['dir_skin'];?>img/banner.jpg" alt="" />
      </div>
    </div>	
  </div>
  <div id="body"<?php if($config['start_page']==$iContent) echo ' class="index"'; ?>>
    <div class="container">
